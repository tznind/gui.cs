...
public class ToplevelTests
{
    ...
    public void GetLocationThatFits_With_Border_Null_Not_Throws ()
    {
        ...
        Exception exception = Record.Exception (() => ((FakeDriverV2)Application.Driver!).SetBufferSize (0, 10));
        Assert.Null (exception);

        exception = Record.Exception (() => ((FakeDriverV2)Application.Driver!).SetBufferSize (10, 0));
        Assert.Null (exception);
    }
